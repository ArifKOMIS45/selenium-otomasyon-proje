...
public class Test_Gender_Selection extends BaseTest {
    ...
    public void check_male_radio_button() {
        ...
        Assertions.assertTrue(practiceFormPage.genderSection().isRadioButtonCheck(GenderSection.Genders.MALE),
    ...
    public void check_female_radio_button() {
        ...
        Assertions.assertTrue(practiceFormPage.genderSection().isRadioButtonCheck(GenderSection.Genders.FEMALE),
    ...
    public void check_other_radio_button() {
        ...
        Assertions.assertTrue(practiceFormPage.genderSection().isRadioButtonCheck(GenderSection.Genders.OTHER),
